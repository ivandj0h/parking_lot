  ...
  rl.on("line", async (input) => {
    ...
    switch (input[0]) {
      ...
      case "registration_numbers_for_cars_with_colour":
        try {
          const result =
            await parkingLotInstance.getRegistrationNumbersFromColor(
              input[1].trim()
            );
          console.log(result);
        } catch (e) {
      ...
      case "slot_numbers_for_cars_with_colour":
        try {
          const result = await parkingLotInstance.getSlotNumbersFromColor(
            input[1].trim()
          );
          console.log(result);
        } catch (e) {
      ...
      case "slot_number_for_registration_number":
        try {
          const result = await parkingLotInstance.getSlotNumberFromRegNo(
            input[1].trim()
          );
          console.log(result);
        } catch (e) {
